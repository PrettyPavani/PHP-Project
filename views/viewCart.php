...
<body>
                    ...
                    <table class="table text-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">
                                    <form action="/models/users/manageCart.php" method="POST">
                                        <button name="removeAllItem" class="btn btn-sm btn-outline-danger">Remove All</button>
                                        <input type="hidden" name="user_id" value="<?php $userId = $_SESSION['user_id']; echo $userId ?>">
                                    </form>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                              include "../models/users/viewCart.php";
                            if($counter==0) {
            ...
            <div class="col-lg-4">
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#checkoutmodal">Proceed</button>                    
                    ...
                    <div class="pt-4">
                        ...
                        <div class="collapse" id="collapseExample">
                          <div class="mt-3">
                              ...
                              <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="0000 0000 0000 0000" maxlength=16>
                            ...
                            <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#checkoutmodal">Proceed with Online Payment</button> 
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateCart(id) {
            $.ajax({
                url: 'models/users/manageCart.php',
                type: 'POST',
