	  	...
	  	<form action="../models/admin/menu.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/assets/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="../controller/admin/menuController.php" method="post">
			...
			<div class="text-left my-2 row">
				...
				<div class="form-group col-md-6">
					<b><label for="categoryId">Category Id</label></b>
                	<input class="form-control" id="categorie_id" name="categorie_id" value="<?php echo $categorieId; ?>" type="number" min="1" required>
				</div>
            </div>
            <div class="text-left my-2">
                <b><label for="desc">Description</label></b>
                <textarea class="form-control" id="desc" name="desc" rows="2" required minlength="6"><?php echo $desc; ?></textarea>
            </div>
            <input type="hidden" id="pizzaid" name="pizzaid" value="<?php echo $pizzaId; ?>">
