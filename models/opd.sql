...
INSERT INTO `categories` (`id`, `name`, `desc`, `createdate`) VALUES
...
CREATE TABLE `contact` (
  ...
  `order_id` int(21) NOT NULL DEFAULT 0 COMMENT 'If problem is not related to the order then order id = 0',
...
CREATE TABLE `deliverydetails` (
  ...
  `deliverypersonname` varchar(35) NOT NULL,
  `deliverypersonphoneno` bigint(25) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `orderstatus` enum('0','1','2','3','4','5','6') NOT NULL DEFAULT '0' COMMENT '0=Ordered Successfully.\r\n1=Order Confirmed.\r\n2=Preparing your Order.\r\n3=On the way!\r\n4=Order Delivered.\r\n5=Order Denied.\r\n6=Order Cancelled.',
  `createdate` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pizza` (`pizzaid`, `name`, `price`, `desc`, `categorie_id`, `createdate`) VALUES
...
ALTER TABLE `categories`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `categories` ADD FULLTEXT KEY `name` (`name`,`desc`);
...
ALTER TABLE `pizza` ADD FULLTEXT KEY `pizzaName` (`name`,`desc`);
